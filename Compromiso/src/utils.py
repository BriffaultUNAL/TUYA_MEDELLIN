...
last_day_previous_moth = calendar.monthrange(current_year, current_month-1)[1]
...
def webscraping(import_username: str, import_password: str, *_):
    ...
    try:
        ...
        asyncio.run(enviar_mensaje(f'Tuya Compromisos'))
        ...
        driver.get(
            """https://172.226.124.46/vsmart/index.php?rtr=informes&ctr=InformesControlador&acc=&nom_programa=informescompromisos_smart""")

        WebDriverWait(driver, 30).until(
            EC.presence_of_element_located((By.XPATH, "//*[@id='ulCriterios']/li/table/tbody/tr/td[2]/button"))).click()

        WebDriverWait(driver, 30).until(
            EC.presence_of_element_located((By.CLASS_NAME, "select2-chosen"))).click()

        WebDriverWait(driver, 30).until(
            EC.presence_of_element_located((By.XPATH, "//*[@id='select2-drop']/ul/li[44]/div"))).click()

        WebDriverWait(driver, 30).until(
            EC.presence_of_element_located((By.ID, "s2id_col"))).click()

        WebDriverWait(driver, 30).until(
            EC.presence_of_element_located((By.XPATH, "//*[@id='select2-drop']/ul/li[31]/div"))).click()
        ...
        WebDriverWait(driver, 30).until(
            EC.presence_of_element_located((By.XPATH, "//*[@id='ui-datepicker-div']/div[2]/button[1]"))).click()
        ...
        WebDriverWait(driver, 30).until(
            EC.presence_of_element_located((By.XPATH, "//*[@id='select2-drop']/ul/li[29]/div"))).click()

        WebDriverWait(driver, 30).until(
            EC.presence_of_element_located((By.XPATH, "//*[@id='s2id_ope']/a/span[1]"))).click()

        WebDriverWait(driver, 30).until(
            EC.presence_of_element_located((By.XPATH, "//*[@id='select2-drop']/ul/li[13]/div"))).click()

        WebDriverWait(driver, 30).until(
            EC.presence_of_element_located((By.CSS_SELECTOR, "a#btnCalendario .ui-datepicker-trigger"))).click()

        calendario = WebDriverWait(driver, 30).until(
            EC.presence_of_element_located((By.XPATH, "//*[@id='ui-datepicker-div']/table/tbody")))
        ...
        element = WebDriverWait(driver, 180).until(
            EC.presence_of_element_located((By.XPATH, "//*[@id='0']/td[3]")))

        action_chains.double_click(element).perform()

        WebDriverWait(driver, 180).until(
            EC.presence_of_element_located((By.XPATH, "/html/body/div[2]/div[1]/div/div[3]/div/div[2]/div[2]/div/div[2]/a[3]"))).click()

        WebDriverWait(driver, 180).until(
            EC.presence_of_element_located((By.XPATH, "/html/body/div[2]/div[1]/div/div[3]/div/div[2]/div[2]/div/div/span[1]/a[2]"))).click()

        WebDriverWait(driver, 180).until(
            EC.presence_of_element_located((By.XPATH, "/html/body/div[2]/div[1]/div/div[3]/div/div[2]/div[2]/div/div/div[3]/form/div[4]/input[1]"))).click()
...
def load(df: DataFrame):
    try:
        with engine_61.get_connect() as conn:
            ...
            df.to_sql('tb_informe_compromisos', con=conn,
